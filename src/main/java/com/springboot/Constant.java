...
public class Constant {
     ...
     * 后台管理员角色
     */
    public static final String ACCOUNTANT_ROLE_ID="9cb1ae198322477ca0d3428e89b75dd7";
    /**
     * 商户角色
     */
    public static final String SUPPLIER_ROLE_ID="f693368298944be58ed1f9c8439552e8";
     ...
     * 防重复提交Token缓存
     */
    public static final String REQUIRE_CACHE="requireCache";
    /**
     * 订单序列号缓存
     */
    ...
    public enum CustomerGrade {
    	...
    	private CustomerGrade(String value) {
    		this.value = value;
    	}
    ...
    public enum LoanOrderStatus{
    	...
    	private LoanOrderStatus(String value) {
    		this.value = value;
    	}
    ...
    public enum LoanBillStatus{
    	 ...
    	 * 已还款
    	 */
    	ALREADYREPAY("alreadyRepay"),
    	
    	/**
    	 * 已提前还款
    	 */
    	ALREADYPREPAYMENT("alreadyPrepayment"),
    	...
    	private LoanBillStatus(String value) {
    		this.value = value;
    	}
     ...
     *
     */
    public enum LeaveMessageStatus{
    	...
    	private LeaveMessageStatus(String value) {
    		this.value = value;
    	}
